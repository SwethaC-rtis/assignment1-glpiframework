...
REM
REM NOTE: This file lists source files explicitly (no glob like the Desktop
REM CMakeLists) — any new Scene/*.cpp file (Renderer.cpp, ShaderHelper.cpp,
REM Square.cpp, etc.) must be added to the emcc command below manually.
REM =============================================================================
