 ...
 * All scene logic lives behind Renderer::Instance() — this file has
 * no knowledge of Triangle, Square, or any other concrete Model.
 *
...
#include "Platform.h"   // for LOGI/LOGE
#include "Renderer.h"
// ---------------------------------------------------------------------------
// JNI entry points
// ---------------------------------------------------------------------------
